...
<head>
    ...
    <title>¿TIENES DUDAS SOBRE DÓNDE TIRAR ALGUNOS ENVASES POR SU COMPOSICIÓN O POR SU APARIENCIA?</title>


    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Tangerine:wght@200;600&display=swap" rel="stylesheet">
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        ...
        <chat-component" v-Bind:form="forms" ref="chat" v-show="form['chat'].mostrar"></chat-component>
